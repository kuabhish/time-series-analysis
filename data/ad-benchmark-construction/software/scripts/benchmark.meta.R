...
#
#Given a finished benchmark as input, this program collates the meta-data for
#that benchmark and appends it to the spcified output file.
#
#Note that the meta-data files that accompany the benchmarks in this study
#include a field for the 0.999 confidence intervals of random AP and AUC.
#This program does NOT produce this field, these were appended later.
#
